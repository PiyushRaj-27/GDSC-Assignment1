  ...
  },
  {
   ...
   "category": "laptops",
    ...
    function onClickHandler(){
        ...
        if(searchFor !== ""){
            const searchFilter = data.data.filter((e)=>{
                return e.title.includes(searchFor)
            })
            parentState([searchFilter])
        }
    }
    ...
    return(
        ...
        <div className="searchBar">
            <input className="searchItem" type="text" name="search" placeholder="Search Here" onChange={handleChange} value={search}></input>
            <button className="searchButton" onClick={onClickHandler}>Search</button>
        </div>
        </>
    )
}
